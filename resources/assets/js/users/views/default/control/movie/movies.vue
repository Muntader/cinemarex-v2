<template>
  <div class="xjkax">
    <div class="col-12 movies-page">
      ...
      <div
        class="col-12 sort text-right"
        v-if="$auth.isAuthenticated() === 'active'"
      >
        <div class="btn-group">
          <div class="dropdown ml-1">
            <button
              class="btn btn-sm btn-secondary btn-blue"
            ...
            >
              <a
                ...
                @click="
                  activeTrending = item.value;
                  trendingActiveTranslate = item.translate;
                "
                >{{ $t(item.translate) }}</a
              >
            </div>
          ...
          <div class="dropdown ml-1">
            <button
              class="btn btn-sm btn-secondary btn-blue mr-1"
                      ...
                      >
                        <div class="header pull-right">
                          <div class="mt-0">
                            ...
                            <div
                              class="poster__remove-collection-icon text-right"
                              v-if="item.is_favorite"
                            >
                              <img
                          ...
                          <div class="mt-1">
                            ...
                            >
                              <img
                                ...
                                width="100%"
                                @click.prevent="
                                  ADD_NEW_LIKE(item.id, 'movie', index, 'add')
                                "
                              />
                            </div>
