    ...
    <div class="show_item" v-if="data.movie != null">
      ...
      <div class="show_item__body p-md-5">
        <div class="show_item__header p-4 p-md-5 p-lg-5 p-xl-5">
          <div class="row">
            ...
            <div class="header__collection ml-2">
              <div
                class="add"
                v-if="!data.movie.is_favorite && data.movie.cloud == 'local'"
                @click.prevent="
                  SHOW_COLLECTION_MODAL(
                    data.movie.id,
                    '/storage/backdrops/600_' + data.movie.backdrop,
                    data.movie.name,
                    'movie'
                  )
                "
              ...
              <div
                class="add"
                v-if="!data.movie.is_favorite && data.movie.cloud == 'aws'"
                @click.prevent="
                  SHOW_COLLECTION_MODAL(
                    data.movie.id,
                    md_backdrop + data.movie.backdrop,
                    data.movie.name,
                    'movie'
                  )
                "
              ...
              <div
                class="remove"
                v-if="data.movie.is_favorite"
                @click.prevent="DELETE_FROM_COLLECTION(data.movie.id, 'movie')"
              >
                <img
                  ...
                  width="100%"
                  @click.prevent="
                    DELETE_FROM_COLLECTION(item.id, 'movie', index)
                  "
                />
            ...
            <div class="header__like ml-4">
              <div
                class="add"
                v-if="!data.movie.is_like"
                @click.prevent="ADD_NEW_LIKE(data.movie.id, 'movie', 'add')"
              >
                <img
              ...
              <div
                class="remove"
                v-if="data.movie.is_like"
                @click.prevent="ADD_NEW_LIKE(data.movie.id, 'movie', 'delete')"
              >
                <img
        ...
        <div class="hidden-sm-down body__background-sm-up">
          <img
            :src="'/storage/backdrops/original_' + data.movie.backdrop"
            :alt="data.movie.name"
            class="backdrop"
            width="100%"
            v-if="data.movie.cloud === 'local'"
          />
          <img
            :src="lg_backdrop + data.movie.backdrop"
            :alt="data.movie.name"
            class="backdrop"
            width="100%"
        ...
        <div class="hidden-md-up body__background-sm-down">
          ...
          <router-link
            :to="{
              name: data.movie.users_only
                ? 'movie-player'
                : 'ghost-movie-player',
              params: { id: data.movie.id },
            }"
          >
        ...
        <div class="col-12 show_item__overview">
          <div class="row">
            <div class="col-5 col-md-3 col-xl-2 mt-3 poster-sm-down">
              <div class="poster">
                <progressive-img
                  :src="'/storage/posters/600_' + data.movie.poster"
                ...
                />
                <progressive-img
                  :src="md_poster + data.movie.poster"
                  placeholder="/themes/default/img/loader-image.png"
                  :alt="data.movie.name"
                  width="100%"
                  :aspect-ratio="1.5"
            ...
            <div class="col-12 col-md-8 mt-3 content-sm-down">
              ...
              <div class="col-12 p-0 mt-5 hidden-xs-down __btn-control">
                <div class="btn-group">
                  ...
                  <button
                    class="btn btn-md-up btn-primary btn-trailer ml-4"
                    @click="showplyrmodal = true"
                    v-if="data.movie.trailer !== null"
                  >
                    Watch Trailer
                  </button>
                </div>
              ...
              <div class="col-12 p-0 mt-5 hidden-sm-up __btn-control">
                <div class="btn-group">
                  ...
                  <button
                    class="btn btn-primary btn-trailer ml-4"
                    @click="showplyrmodal = true"
                    v-if="data.movie.trailer !== null"
                  >
                    Watch Trailer
                ...
                <div class="row">
                  <div class="col-12 col-md-8 p-1">
                    <div class="__cast" v-if="data.casts !== null">
                      ...
                      <div
                        class="block ml-sm-2 m-1"
                        v-for="(item, index) in data.casts"
                        :key="index"
                      >
                        <router-link
                          :to="{ name: 'cast', params: { id: item.id } }"
                        >
                  ...
                  <div
                    class="col-12 col-md-4 hidden-lg-down"
                    v-if="data.similar !== null"
                  >
                    <div class="similar">
                      <h3>
                      ...
                      <div class="row">
                        <div
                          ...
                          :key="index"
                        >
                          <div class="image" @click="SIMILAR_SHOW(item.id)">
                            <progressive-img
        ...
        <div
          class="col-12 col-md-8 col-lg-6 offset-md-2 offset-lg-3 trailer"
          :class="{ show: showplyrmodal }"
        >
          <div class="exit">
            <img
              data-v-b12df990=""
              ...
              alt="exit icon"
              width="100%"
              @click="showplyrmodal = false"
            />
          </div>
          <div
            class="plyr"
            data-type="youtube"
            :data-video-id="data.movie.trailer"
          ></div>
        </div>
