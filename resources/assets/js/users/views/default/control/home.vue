        ...
        >
          <slide v-for="(item, index) in data.top" :key="index">
            <div class="top-item__film-cover" v-if="item.type === 'movie'">
              ...
              <img
                :src="'/storage/backdrops/original_' + item.backdrop"
                :alt="item.name"
                width="100%"
                class="backdrop"
                  ...
                  <div class="top-item__film-details">
                    ...
                    <div class="control">
                      <div class="btn-group">
                        ...
                        <button
                          class="
                            btn btn-sm btn-plus btn-circle btn-success
                            ml-1
                          "
                          ...
                          @click.prevent="
                            SHOW_COLLECTION_MODAL(
                              item.id,
                              '/storage/backdrops/600_' + item.backdrop,
                              item.name,
                              'movie',
                              null,
                              index
                        ...
                        <button
                          class="btn btn-sm btn-plus btn-circle btn-danger ml-1"
                          v-if="item.is_favorite"
                          @click.prevent="
          ...
          <div class="row" style="margin: -30px; overflow: hidden">
            <div class="col-12 p-0">
              <div
                class="recenlty m-3"
                v-if="
                  data.recenlty !== null && $auth.isAuthenticated() === 'active'
                "
              >
                <div class="ml-2">
                  <h3>
                ...
                <div class="row">
                  <div
                    class="
                      ...
                      animation
                    "
                    v-for="(item, index) in data.recenlty"
                    :key="index"
                  >
                    <div
                      class="poster"
                    ...
                    <div
                      class="poster"
                      @mouseover="ACTIVE_SLELECTED_SERIES(item.id, rootindex)"
              ...
              <div
                class="carousel mt-1 m-3 mb-5"
                v-for="(item, rootindex) in data.data"
                :key="rootindex"
              ...
              >
                ...
                >
                  <slide
                    ...
                    v-for="(item, index) in data.data[rootindex].list"
                    :key="index"
                  >
                    <div
                      class="poster"
                      @mouseover="ACTIVE_SLELECTED_MOVIE(item.id, rootindex)"
                      v-if="data.data[rootindex].type === 'Movies'"
                    >
                      <router-link
                        :to="{ name: 'show-movie', params: { id: item.id } }"
                      >
                        <div class="poster__backdrop-image">
                          ...
                          <div
                            class="poster__backdrop_overlay-info"
                            v-if="
                              active_movie === item.id &&
                              root_index_active === rootindex
                            "
                          >
                            ...
                            <div class="body text-center">
                              <div class="play" v-if="item.user_only">
                                <router-link
                                  :to="{
                                    name: item.users_only
                                      ? 'movie-player'
                    ...
                    <div
                      class="poster"
                      @mouseover="ACTIVE_SLELECTED_SERIES(item.id, rootindex)"
                      v-if="data.data[rootindex].type === 'Series'"
                    >
                      <router-link
                        :to="{ name: 'show-series', params: { id: item.id } }"
                      >
