  ...
  <div>
    ...
    <div class="wolf-player" v-if="!spinner_load">
      <div class="report-modal" v-if="show_report">
        <div
          class="col-12 col-sm-8 col-lg-6 offset-sm-2 offset-lg-3"
          id="modal"
        >
          <div class="header">
          ...
          <div class="body">
            ...
            <span class="help is-danger" v-show="errors.has('radio_group_1')"
              >Please Choose The Problem</span
            >
            ...
            <div class="textarea-details">
              ...
              <textarea
                ...
                :placeholder="$t('report.more_details')"
                cols="40"
                rows="6"
              ></textarea>
            </div>
