    ...
    <div class="show_item__body p-md-5">
      <div class="show_item__header p-4 ml-2">
        <div class="row">
          ...
          <div class="header__collection ml-2">
            <div
              class="add"
              v-if="!data.series.is_favorite && data.series.cloud == 'local'"
              @click.prevent="
                SHOW_COLLECTION_MODAL(
                  data.series.id,
                  '/storage/backdrops/600_' + data.series.backdrop,
                  data.series.name,
                  'series'
                )
              "
            ...
            <div
              class="add"
              v-if="!data.series.is_favorite && data.series.cloud == 'aws'"
              @click.prevent="
                SHOW_COLLECTION_MODAL(
                  data.series.id,
                  md_backdrop + data.series.backdrop,
                  data.series.name,
                  'series'
                )
              "
            ...
            >
              <img
                ...
                width="100%"
                @click.prevent="
                  DELETE_FROM_COLLECTION(item.id, 'series', index)
                "
              />
      ...
      <div class="hidden-sm-down body__background-sm-up">
        <div v-if="show_season === 1">
          <img
            :src="'/storage/backdrops/original_' + data.series.backdrop"
            :alt="data.series.name"
            class="backdrop"
            width="100%"
            v-if="data.series.cloud === 'local'"
          />
          <img
            :src="lg_backdrop + data.series.backdrop"
            :alt="data.series.name"
            class="backdrop"
            width="100%"
            v-if="data.series.cloud === 'aws'"
          />
        </div>
        ...
        <div v-else>
          <img
            :src="
              ...
              data.season[show_season][0].backdrop
            "
            :alt="data.series.name"
            class="backdrop"
            width="100%"
          ...
          />
          <img
            :src="lg_backdrop + data.season[show_season][0].backdrop"
            :alt="data.series.name"
            class="backdrop"
            width="100%"
            v-if="data.series.cloud === 'aws'"
      ...
      <div class="hidden-md-up body__background-sm-down">
        ...
        <div v-if="data.season !== null">
          <router-link
            :to="{
              name: data.series.users_only
                ? 'series-player'
                : 'ghost-series-player',
              params: { series_id: data.series.id },
            }"
          >
      ...
      <div class="col-12 show_item__overview">
        <div class="row">
          <div class="col-5 col-md-3 col-xl-2 mt-3 poster-sm-down">
            <div class="poster">
              <progressive-img
                :src="'/storage/posters/600_' + data.series.poster"
              ...
              />
              <progressive-img
                :src="md_poster + data.series.poster"
                placeholder="/themes/default/img/loader-image.png"
                :alt="data.series.name"
                width="100%"
                :aspect-ratio="1.5"
          ...
          <div class="col-12 col-md-8 mt-3 content-sm-down">
            ...
            <div
              class="col-12 p-0 mt-5 __btn-control"
              v-if="data.season !== null"
            >
              <div class="btn-group">
                <router-link
                  :to="{
    ...
    <div class="col-12 season">
      ...
      <div class="col-12 season-list">
        <div class="col-12 p-3 text-right hidden-md-up">
          <div class="dropdown">
            ...
            >
              <a
                class="dropdown-item"
                v-for="(item, index) in data.season"
                :key="index"
                :class="{ active: show_season == index }"
                @click="show_season = index"
                >{{ $t("show.season") + index }}</a
              >
            </div>
          </div>
        </div>
        ...
        <div class="col-12 mt-2 p-0 episode" v-if="data.season !== null">
          <div class="row">
            <div
              class="col-md-1 season-list hidden-sm-down"
              v-if="data.season !== null"
            >
              ...
              <div class="row">
                <div
                  class="
                    ...
                    p-xs-3 p-md-0
                  "
                  v-for="(item, index) in data.season[show_season]"
                  :key="index"
                >
                  <div class="episode_contnet">
                    <div class="backdrop">
                      ...
                      >
                        <progressive-img
                          :src="'/storage/backdrops/600_' + item.backdrop"
                          :alt="item.name"
                          :blur="0"
                          v-if="item.cloud == 'local'"
                        />
                        <progressive-img
                          :src="md_backdrop + item.backdrop"
                          :alt="item.name"
                          :blur="0"
                          v-if="item.cloud == 'aws'"
                        />
